...
def format_file(info,url):
        ...
        text_theme=info[2]
        first_line="\t{}\n\n".format(url)
        para_1="""\t<p><a href="index.php?option=com_content&amp;view=article&amp;
        		id={}:{}&amp;catid=27:{}&amp;lang=lt-LT"><strong><em>{} </em>{}</strong>
        		</a></p><p>&nbsp;</p>\n\n""".format(url_id,last_term,url_part,year_term,title_term)				
        para_2="""\t<p><strong>{}</strong> - {} - gynė:&nbsp;<em>{}</em><br />{}<br />{}&nbsp;<strong>
        		<a href="{}" target="_blank" rel="noopenernoreferrer" class="wf_file">
        		<spanclass="wf_file_text">{}</span></a></strong>&nbsp;[anglų k.] 
        		(<a href="{}" target="_blank" rel="noopenernoreferrer" class="wf_file">
        		<spanclass="wf_file_text">santrauka</span></a>)</p>\n\n""".format(title_term,term1,year_term,prof_term,text_term,text_link,text_theme,text_link_2)
